...
output:
  ...
  bibliography: refs/references2.bib
---
...
A two-way ANOVA compared the relationship between localisation and essentiality on the stability of their respective mRNAs. Localisation data was taken from [][@matsuyama2006]. Results (Figure \@ref(fig:barplot))
